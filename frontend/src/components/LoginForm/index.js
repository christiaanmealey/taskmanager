...
function LoginForm() {
    const { user, token, isAuthenticated, error, login, logout } = useAuth();
            ...
            <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
                ...
                <form className="space-y-4 md:space-y-6" onSubmit={submitHandler}>
                    ...
                    <div>
                        ...
                        <input className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="password" name="password" id="password" required ref={passwordRef} />
                    </div>
                    <div className="flex items-center justify-between">
                        ...
                        <a href="#" className="text-sm font-medium hover:underline text-primary-600 dark:text-primary-500">Forgot password?</a>
                    </div>
